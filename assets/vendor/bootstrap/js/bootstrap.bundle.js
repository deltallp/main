...
(function (global, factory) {
  ...
  */
  ...
  function getCompositeRect(eleDelta3VirtualElement, offsetParent, isFixed) {
    if (isFixed === void 0) {
      isFixed = false;
    }
    ...
    var rect = getBoundingClientRect(eleDelta3VirtualElement, offsetParentIsScaled, isFixed);
    var scroll = {
      scrollLeft: 0,
      scrollTop: 0,
    };
